...
contract E1RegistryGPS {
    ...
    struct TripGPSParams {
        ...
        uint16 startElevation; // Elevação em metros
    }
    ...
    function _calculateE1(
        ...
        // ✏️ NOVO: Aplicar fator de elevação
     ...
     * Veículos em regiões montanhosas consomem mais combustível
    ...
    function _getElevationFactor(
        ...
        // 300-600m: Montanhoso (+15%)
        else if (elevation <= 600) {
            return 115;
        }
        // 600-1000m: Muito montanhoso (+25%)
        else if (elevation <= 1000) {
            return 125;
        }
        // > 1000m: Extremamente montanhoso (+40%)
        else {
            return 140;
        }
    }
