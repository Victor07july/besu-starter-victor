...
contract E1RegistryTelemetry {
    ...
    function registerTrip(
        ...
        uint256 fuelConsumed = (params.fuelRateAvg * params.tripDuration) / 3600;
        ...
        int256 valorE1 = (int256(emissao) * int256(params.carbonPrice)) / int256(1_000_000 * 1e6);
    ...
    function _calculateEmission(
        ...
        uint256 emissaoGasolina = (fuelConsumed * EMISSAO_GASOLINA * gasolineRatio) / (100 * 1e3 * 1e3);
        uint256 emissaoEtanol = (fuelConsumed * EMISSAO_ETANOL * ethanolRatio) / (100 * 1e3 * 1e3);
     ...
     */
    function batchProcessPayments(uint256[] memory _tripIds) external onlyOwner {
     ...
     */
    function getTripsByVIN(string memory vin) 
