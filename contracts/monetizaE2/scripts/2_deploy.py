...
with open("../contracts/CarbonCreditNFT_E2.json") as f:
    ...
    abi = contract_json['contracts']['../contracts/CarbonCreditNFT_E2.sol']['CarbonCreditNFT_E2']["abi"]
    bytecode = contract_json['contracts']['../contracts/CarbonCreditNFT_E2.json']['CarbonCreditNFT_E2']['evm']["bytecode"]['object']
